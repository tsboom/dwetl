...
class EzproxyProcessor(Processor):
    ...
    def __init__(self, reader, writer, job_info, logger, session2):
        super().__init__(reader, writer, job_info, logger, session2)

    def job_name(self):
        return 'EzproxyProcessor'
        
    @classmethod
    def clndr_dt_dim_lookup(cls, item, session2):
        """
    ...
    @classmethod
    def time_of_day_dim_key_lookup(cls, item, session2):
        """
    ...
    @classmethod
    def library_dim_lookup(cls, item, session2):
        """
    ...
    @classmethod
    def transform(cls, item, logger, session2):
        """
    ...
    def process_item(self, item):
        processed_item = EzproxyProcessor.transform(item, self.logger, self.session2)
