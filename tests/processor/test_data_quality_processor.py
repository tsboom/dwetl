...
class TestDataQualityProcessor(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        with open('table_config/bibliographic_record_dimension.json') as json_file:
            ...
            #whole_json_config= json.load(json_file)
            #cls.bib_rec_json_config = whole_json_config['z13_open_date']['dataquality_info']
    ...
    def test_get_suspend_record_code(self):
        ...
        json_config = whole_json_config['z13_open_date']['dataquality_info'][0]
    ...
    def test_dataquality_bib_rec(self):
        ...
        pdb.set_trace()
        self.assertEqual("(null)", results[0]['dq_z13_open_date'])
        self.assertEqual(1, results[0]['rm_dq_check_excptn_cnt'])
        #self.assertEqual("MIS", results[0]['rm_suspend_rec_reason_cd'])
        #pdb.set_trace()
        self.assertEqual("(null)", results[1]['dq_z13_open_date'])
        ...
        self.assertEqual('20130225', results[0]['dq_z13_update_date'])
        self.assertEqual('1969', results[0]['dq_z13_year'])
