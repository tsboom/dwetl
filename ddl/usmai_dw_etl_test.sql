...
ALTER DATABASE usmai_dw_etl_test OWNER TO postgres;
...
ALTER TABLE ONLY public.dw_stg_2_bib_rec_z00
    ADD CONSTRAINT pk_dw_stg_2_bib_rec_z00 PRIMARY KEY (db_operation_cd, rec_trigger_key, dw_stg_2_aleph_lbry_name, in_z00_doc_number, em_create_dw_prcsng_cycle_id);
